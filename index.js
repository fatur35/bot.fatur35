...
/////////////////
const BotName = 'FATUR BOT☄'; 
const instagram = 'https://instagram.com/faturrohman_35'; 
const telegram = 'https://t.me/faturrohman'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:faturrohman_35')
